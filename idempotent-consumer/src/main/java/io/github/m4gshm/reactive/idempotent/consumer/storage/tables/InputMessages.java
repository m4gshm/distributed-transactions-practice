...
public class InputMessages extends TableImpl<InputMessagesRecord> {
     ...
     */
    public final TableField<InputMessagesRecord, String> MESSAGE_ID = createField(DSL.name("message_id"), SQLDataType.CLOB.nullable(false), this, "");
     ...
     */
    public final TableField<InputMessagesRecord, OffsetDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
    ...
    public UniqueKey<InputMessagesRecord> getPrimaryKey() {
        return Internal.createUniqueKey(InputMessages.INPUT_MESSAGES, DSL.name("input_messages_pkey"), new TableField[] { InputMessages.INPUT_MESSAGES.MESSAGE_ID, InputMessages.INPUT_MESSAGES.SUBSCRIBER_ID }, true);
    }
