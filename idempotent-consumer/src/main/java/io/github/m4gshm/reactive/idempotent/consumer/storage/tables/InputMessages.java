...
public class InputMessages extends TableImpl<InputMessagesRecord> {
    ...
    /**
     * The column <code>input_messages.id</code>.
     */
    public final TableField<InputMessagesRecord, String> ID = createField(DSL.name("id"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>input_messages.subscriber_id</code>.
     */
    public final TableField<InputMessagesRecord, String> SUBSCRIBER_ID = createField(DSL.name("subscriber_id"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>input_messages.partition_id</code>.
     */
    public final TableField<InputMessagesRecord, LocalDate> PARTITION_ID = createField(DSL.name("partition_id"), SQLDataType.LOCALDATE.nullable(false), this, "");

    /**
     * The column <code>input_messages.event_timestamp</code>.
     */
    public final TableField<InputMessagesRecord, OffsetDateTime> EVENT_TIMESTAMP = createField(DSL.name("event_timestamp"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");

    /**
     * The column <code>input_messages.created_at</code>.
     */
    public final TableField<InputMessagesRecord, OffsetDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");

    private InputMessages(Name alias, Table<InputMessagesRecord> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private InputMessages(Name alias, Table<InputMessagesRecord> aliased, Field<?>[] parameters, Condition where) {
    ...
    public UniqueKey<InputMessagesRecord> getPrimaryKey() {
        return Internal.createUniqueKey(InputMessages.INPUT_MESSAGES, DSL.name("input_messages_pkey"), new TableField[] { InputMessages.INPUT_MESSAGES.PARTITION_ID, InputMessages.INPUT_MESSAGES.SUBSCRIBER_ID, InputMessages.INPUT_MESSAGES.ID }, true);
    }
