 ...
 */
package io.github.m4gshm.idempotent.consumer.storage.tables;
...
public class InputMessages extends TableImpl<InputMessagesRecord> {
     ...
     */
    public final TableField<InputMessagesRecord, String> ID = createField(DSL.name("id"),
     ...
     */
    public final TableField<InputMessagesRecord, String> SUBSCRIBER_ID = createField(DSL.name("subscriber_id"),
            SQLDataType.CLOB.nullable(false),
            this,
            "");
     ...
     */
    public final TableField<InputMessagesRecord, LocalDate> PARTITION_ID = createField(DSL.name("partition_id"),
     ...
     */
    public final TableField<InputMessagesRecord, OffsetDateTime> EVENT_TIMESTAMP = createField(DSL.name(
            "event_timestamp"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");

    /**
     * The column <code>input_messages.created_at</code>.
     */
    public final TableField<InputMessagesRecord, OffsetDateTime> CREATED_AT = createField(DSL.name("created_at"),
    ...
    public UniqueKey<InputMessagesRecord> getPrimaryKey() {
        return Internal.createUniqueKey(InputMessages.INPUT_MESSAGES,
                ...
                new TableField[] { InputMessages.INPUT_MESSAGES.PARTITION_ID,
                        InputMessages.INPUT_MESSAGES.SUBSCRIBER_ID,
                        InputMessages.INPUT_MESSAGES.ID },
                true);
    }
