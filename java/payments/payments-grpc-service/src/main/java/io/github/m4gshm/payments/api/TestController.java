...
public class TestController {
    ...
    private final ReactiveAccountEventService reactiveAccountEventService;
    ...
    public Mono<String> sendAccountBalanceEvent(@RequestBody AccountBalanceEvent body) {
        return reactiveAccountEventService.sendAccountBalanceEvent(body.clientId, body.balance, body.timestamp)
                .flatMap(r -> {
