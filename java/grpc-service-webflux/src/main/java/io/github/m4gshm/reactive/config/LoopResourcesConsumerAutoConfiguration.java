...
import io.github.m4gshm.config.GrpcServerCustomizerAutoConfiguration;
...
@AutoConfiguration(after = { GrpcServerCustomizerAutoConfiguration.class, LoopResourcesAutoConfiguration.class })
